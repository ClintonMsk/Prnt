...
function CkeBasic(id) {
    CKEDITOR.replace( id,{
        customConfig: '/cke/config_basic.js',
    });
}

function CkeFull(id) {
    CKEDITOR.replace(id,{
        ///customConfig: '/cke/config_fulljs',
        ...
        qtPreviewBorder: '1px solid black', // preview table border
...
function Gotopage(Key) {
   ...
   if(search != "" ){
        ...
        window.location = (url + "/"+Key+"/" + sort + "/" + order + "/" + limit + "/" + page + "/"+all);
    }
