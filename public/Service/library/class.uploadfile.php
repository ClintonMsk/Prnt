  <?PHP
	 ...
	 function image_upload_original ($set_image,$set_dir,$set_name,$percent){
		 ...
		 $newname = $set_name."_Original.jpg";
		 $path = $set_dir;
	...
	die("Image not found or not an image");
	 ...
	 // return $pathcopy;
		...
		function upload_file ($file,$name,$directory,$filetype){
		    copy($file,$directory."/".$name.".".$filetype);
        }


          function upload_file_del ($file,$name,$directory,$filetype){
              copy($file,$directory."/".$name.".".$filetype);
 ...
 function upload_thumb($source_image,$set_dir,$set_name,$tn_w = 100,$tn_h = 100,$quality = 80,$wmsource = false) {
  ...
  if(Imagejpeg($final,$pathcopy,$quality)) {
    return true;
  }
  return false;
